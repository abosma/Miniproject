...
#Labels
thelabel = Label(root, text=lineTweet)  #teskst
...
#buttons
button1 = Button(text="Accept", fg="green", command=acceptTweet(lineTweet))  #button Accept
button2 = Button(text="Reject", fg="red", command=rejectTweet(lineTweet))  #button REject
